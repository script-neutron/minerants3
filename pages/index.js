  ...
  return (
    <div>
      ...
      <div className=" text-white p-4 m-4">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-3 m-4 justify-evenly text-center items-center p-3">
          ...
          <h1 className="text-1xl font-bold  text-white text-center">
            {' '}
            $MANT is the native token of MinerAnts. A super-defaltionary and
            auto liquidity adding token used for MinerAnts blind box opening ,
            <br />
            mining rewards, payment on 3rd party marketplaces connected to
            MinerAnts
          </h1>
          <div className="mini-cards flex flex-col p-2 rounded-xl border-2 border-rose-500 text-lg font-medium">
            <h1>10,000</h1>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2 m-4 text-lg font-medium  text-black items-center ">
          <div className="text-center border border-sky-500 rounded-lg p-3 bg-amber-400 m-4">
            ...
            <h1>6% buy tax for liquidity</h1>
            <h2 className="text-base">
              6% of every buy transaction is converted into liquidity. This is
              automatic and helps to create a price floor (stability)
            </h2>
          </div>
          <div className="text-center border border-sky-500 rounded-lg p-3 bg-amber-400 m-4">
            <BsFillSafeFill fontSize="3rem" style={{ margin: 'auto' }} />
            <h1>8% sell tax for liquidity</h1>
            <h2 className="text-base">
              8% of every sell transaction is converted into liquidity. This is
              automatic and helps to create a price floor
            </h2>
          </div>
          <div className="text-center border border-sky-500 rounded-lg p-3 bg-amber-400 m-4">
            <BsPeopleFill fontSize="3rem" style={{ margin: 'auto' }} />
            <h1>3% buy tax for Marketing</h1>
            <h2 className="text-base">
              We set up a marketing wallet (5% of supply) for every buy
              transactions to help support our marketing outreach in the coming
              months
            </h2>
          </div>
          <div className="text-center border border-sky-500 rounded-lg p-3 bg-amber-400 m-4">
            <BsPeopleFill fontSize="3rem" style={{ margin: 'auto' }} />
            <h1>3% sell tax for Marketing</h1>
            <h2 className="text-base">
              We set up a marketing wallet (7% of supply) for every sell
              transactions to help support our marketing outreach in the coming
              months
            </h2>
          </div>
      ...
      <br />
      <h1 className="text-2xl font-bold text-center text-white mt-8 py-8">
        FEATURES
      </h1>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2 m-4">
        <div className="p-3 m-4 border-2 border-rose-500 rounded-lg bg-stone-800 text-white">
          <h1 className="text-xl font-bold text-rose-600">
            NFT automated mining
          </h1>
          <h2 className="text-base font-bold text-orange-400">
            Mine $MANT tokens with your Miner Ants NFTs
          </h2>
          <h3>
            Earn high ROI in $MANT from our automated NFT system when you get
            MinerAnt NFTs
          </h3>
        </div>
        <div className="p-3 m-4 border-2 border-rose-500 rounded-lg bg-stone-800 text-white">
          ...
          <h2 className="text-base font-bold text-orange-400">
            Miner Ant Mini Games
          </h2>
          <h3>Bet against other players in skill based mini-games to earn $MANT tokens</h3>
        </div>
        <div className="p-3 m-4 border-2 border-rose-500 rounded-lg bg-stone-800 text-white">
          <h1 className="text-xl font-bold text-rose-600">Stake-To-Earn</h1>
          <h2 className="text-base font-bold text-orange-400">
            Earn high returns from Staking $MANT
          </h2>
          <h3>
            Earn up to 2,000% APY $MANT tokens rewards from staking $MANT
            tokens.
          </h3>
        </div>
        <div className="p-3 m-4 border-2 border-rose-500 rounded-lg bg-stone-800 text-white">
          ...
          <h2 className="text-base font-bold text-orange-400">
            Get access to Miner Ant comics with $MANT
          </h2>
          <h3>
            Your MinerAnt NFT gets you access to MinerAnts comics . If you are
            lucky you can stand a chance to be a contributor in new chapters in
            the comics.
          </h3>
        </div>
      </div>

      <h1 className="text-2xl font-bold text-center text-white p-3 mt-8 py-8">
        GET YOUR FIRST MINER ANT EGG
      </h1>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4 m-4">
        <div className="card">
          <Image src={ant1} alt="logo" className="rounded-2xl" />
          <div className="flex flex-col text-white">
            <h1 className="text-2xl font-bold text-center p-3">SCRIPT</h1>
            <h2 className="text-lg font-bold text-center p-3 text-red-500">
              Smart contract and Web Developer
            </h2>
          </div>
        </div>
