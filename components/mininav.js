    ...
    <div>
      <div className="mx-8 flex justify-center">
        <div className="p-2 m-3">
          <h1
            className="hover:bg-orange-600 cursor-pointer p-2 walletaddr border-2 border-orange-50 rounded-sm text-white text-bold text-xl font-bold m-4"
      ...
      <div className="xmodal">
        <div className="xmodal-content">
          <span className="xclose-button" onClick={xwallettoggle}>
            X
          </span>
